...
function addPlant() {
    ...
    // Save plantArray to localStorage
    localStorage.setItem("plantArray", JSON.stringify(plantArray));
...
document.addEventListener("DOMContentLoaded", function (event) {
    if (localStorage.getItem("plantArray")) {
...
function createPlantList() {
    ...
    plantArray.forEach(function (element) {   // use handy array forEach method
        ...
        a.innerHTML = element.ID+": <strong>Plant Name:</strong>  "+element.name;
        a.href = "#detailPage";
